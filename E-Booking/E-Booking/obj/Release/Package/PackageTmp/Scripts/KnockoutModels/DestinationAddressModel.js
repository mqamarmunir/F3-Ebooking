function DestinationAddressModel() {
    ...
    self.DepartmentId = ko.observable().extend({ required: { onlyIf: function () { return !self.IsThisPatientHomeAddress() && parseInt(self.FacilityTypeId()) == 4 } } });
